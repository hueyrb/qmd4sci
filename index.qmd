...
This is a book on quarto and aimed for scientists interested in reproducibility. It was initially developed as a 3-hour workshop, "Rmarkdown for scientists" and then formulated as an open-access book. It has been updated to use quarto, which is a more updated and modern take on rmarkdown. It now serves as an introductory resource that will grow and change over time as a **living book**.
...
- Manage figures and tables
    - Reference figures and tables in text so that they dynamically update if the data change
    - Create captions for figures and tables
    - Change the size, resolution, and type of figures
...
The quarto guide (above) is extensive, and indeed this present book overlaps with "quarto manuscripts" guide. 

> So, why write a book?

Good question. The answer is that the structure of a book also serves as a framework for am introductory workshop, even one scheduled for only a few hours. It is not to say that there aren't already great resources out there; there are. It is instead adding to the list of other useful information out there on the internet. I considered the Rmarkdown for Scientsts book and course a success, and it helped me and others understand and better use rmarkdown. So I guess, to answer a question with another question:
...
The following sections of the book can be worked through in 3 hours:
...
The remaining sections can be used as extra material for self study, or to extend the workship:
...
## Where has this workshop been taught?

The quarto for scientists workshop has not been taught yet, but the rmarkdown for scientists workshop, upon which this book is based, has been taught at the following locations:
