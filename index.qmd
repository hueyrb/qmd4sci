...
- Next steps:
  - Use Qaurto for other formats, such as slides, websites, books, and more
...
With the [release of Quarto](https://posit.co/blog/announcing-quarto-a-new-scientific-and-technical-publishing-system/), I wanted to translate the materials I developed in "Rmarkdown for scientists" to cover the same material. Here are some great resources for learning Quarto:
...
Course materials can be downloaded by using the following command from the `usethis` package in Quarto:
